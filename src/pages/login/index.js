  ...
  return (
    <Box className='content-right' sx={{ backgroundColor: 'background.paper' }}>
      {!hidden ? (
        ...
        >
          <LoginIllustration alt='login-illustration' src={`/admin/images/pages/${imageSource}-${theme.palette.mode}.png`} />
          ...
          <Box sx={{ width: '100%', maxWidth: 400 }} style={{
            ...
            <Box sx={{ my: 6 }} style={{
              ...
              <Typography variant='h5' sx={{ mb: 1.5 }}>
                {`SIAKAD AKADEMIK SEKOLAH ISLAM TERPADU - MANAGEMENT SYSTEM 👋🏻`}
              </Typography>
